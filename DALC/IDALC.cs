...
List<News> Get_News_By_Criteria ( string TITLE, string DESCRIPTION, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
List<News> Get_News_By_Where ( string TITLE, string DESCRIPTION, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
...
List<Section> Get_Section_By_Criteria ( string SECTION_NAME, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
List<Section> Get_Section_By_Where ( string SECTION_NAME, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
List<Team_member> Get_Team_member_By_Criteria ( string MEMBER_NAME, string POSITION, string MAJOR, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
List<Team_member> Get_Team_member_By_Where ( string MEMBER_NAME, string POSITION, string MAJOR, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
...
List<News> Get_News_By_Criteria_Adv ( string TITLE, string DESCRIPTION, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
List<News> Get_News_By_Where_Adv ( string TITLE, string DESCRIPTION, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
List<Section> Get_Section_By_Criteria_Adv ( string SECTION_NAME, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
List<Section> Get_Section_By_Where_Adv ( string SECTION_NAME, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
List<Team_member> Get_Team_member_By_Criteria_Adv ( string MEMBER_NAME, string POSITION, string MAJOR, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
List<Team_member> Get_Team_member_By_Where_Adv ( string MEMBER_NAME, string POSITION, string MAJOR, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
...
Int32? Edit_News ( Int32? NEWS_ID, string TITLE, string DESCRIPTION, bool? IS_DISPLAYABLE, long? ENTRY_USER_ID, string ENTRY_DATE, Int32? OWNER_ID);
Int32? Edit_Owner ( Int32? OWNER_ID, string CODE, string MAINTENANCE_DUE_DATE, string DESCRIPTION, string ENTRY_DATE);
Int32? Edit_Section ( Int32? SECTION_ID, string SECTION_NAME, long? ENTRY_USER_ID, string ENTRY_DATE, Int32? OWNER_ID);
Int32? Edit_Team_member ( Int32? TEAM_MEMBER_ID, string MEMBER_NAME, string POSITION, string MAJOR, long? ENTRY_USER_ID, string ENTRY_DATE, Int32? OWNER_ID);
